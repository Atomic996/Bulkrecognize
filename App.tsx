              ...
              <div className="relative z-10 flex justify-between items-start gap-4">
                 ...
                 <div className="flex flex-col items-end gap-2">
                    <div className="px-4 py-1.5 sm:px-6 sm:py-2 bg-[#00f2ff]/10 border border-[#00f2ff]/30 rounded-full backdrop-blur-xl">
                       <span className="text-[14px] sm:text-[20px] font-black text-[#00f2ff] uppercase tracking-widest">Verified</span>
                    </div>
                    <span className="text-[10px] font-mono text-white/40 uppercase tracking-tighter">ID: {getDeviceID().replace('node-','')}</span>
                 </div>
              </div>
